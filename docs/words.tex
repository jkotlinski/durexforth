...
\item[latest (variable)] Dictionary position of latest defined word.

\item[top (value)] Gets the top of the dictionary. (default: \$6fff)

\item[top! ( addr -- )] Relocates the dictionary to \texttt{addr}.
