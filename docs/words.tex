...
\item[allocate ( size -- addr )] Allocates a block of memory \texttt{size} bytes large in the heap, returning its address.
\item[free ( addr -- )] Frees a block of memory created by \texttt{allocate}.
