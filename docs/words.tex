...
\item[openw ( filenameptr filenamelength file\# sa\# -- )] Open file with logical number \texttt{file\#} and secondary address \texttt{sa\#} for writing.
\item[close ( file\# -- )] Close file with logical number \texttt{file\#}.
\end{description}
