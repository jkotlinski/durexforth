...
\item One by one, load the modules you want included with your new Forth. (E.g. \texttt{" debug" load})
\item Save the new system with e.g. \texttt{" acmeforth" save-forth}.
\end{enumerate}
