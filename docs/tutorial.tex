...
Start the editor by typing \texttt{s" foo" edit}.\footnote{Yes, the space should be between \texttt{s"} and \texttt{foo"}. The \texttt{s"} word creates a string by reading characters until it hits a \texttt{"}.}
