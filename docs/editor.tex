...
The editor is a vi clone. Launch it by entering \texttt{v foo} in the interpreter (foo being
the file you want to edit). You may also enter \texttt{v} with no parameters on stack - in
that case, it will create a text file named "noname" if no buffer is already open. For more info about vi style editing, see \href{http://www.vim.org}{the Vim web site}.
