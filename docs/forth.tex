...
\item[create xxx] Create a dictionary header with name \texttt{xxx}. This can be used to create an array:
\begin{verbatim}
...
\begin{description}
\item[' xxx ( -- addr )] Find execution token of word xxx.
\item[['{]}] Used only in colon definitions. Compile the execution token of next word as a literal.
