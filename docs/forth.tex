...
\item[um/mod ( ud d -- r q )] Divide double-cell number ud by d, giving remainder r and quotient q. Values are unsigned.
\item[sm/rem ( d n -- r q )] Divide double-cell number d with n, giving the symmetric quotient q and the remainder r. Values are signed.
\item[fm/mod ( d n -- r q )] Divide double-cell number d with n, giving the floored quotient q and the remainder r. Values are signed.
...
Words for double numbers.

\item[dabs ( d -- ud )] Produces the absolute value of d.
\item[dnegate ( d -- d )] Negates the double-cell number d.
