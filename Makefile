...
forth_src/music.pet: forth_src/music.fs ext/petcom
	cat forth_src/music.fs | ext/petcom - > forth_src/music.pet

FORTHLIST=base debug vi asm gfx gfxdemo rnd sin ls turtle fractal purge-hidden sprite doloop jsr float labels music

durexforth.d64: durexforth.prg forth_src/base.pet forth_src/debug.pet forth_src/vi.pet forth_src/asm.pet forth_src/gfx.pet forth_src/gfxdemo.pet forth_src/rnd.pet forth_src/sin.pet forth_src/ls.pet forth_src/turtle.pet forth_src/fractal.pet forth_src/purge-hidden.pet forth_src/sprite.pet forth_src/doloop.pet forth_src/jsr.pet forth_src/float.pet forth_src/labels.pet forth_src/music.pet Makefile
