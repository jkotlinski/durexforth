...
deploy: deploy/durexforth-$(TAG_DEPLOY).pdf deploy/durexforth-$(TAG_DEPLOY).d64 deploy/durexforth-$(TAG_DEPLOY).crt
...
deploy/durexforth-$(TAG_DEPLOY).d64: durexforth.d64
	...
	x64sc -warp +confirmonexit deploy/durexforth-$(TAG_DEPLOY).d64
...
durexforth.prg: *.asm
	$(AS) -f cbm -o $@ --vicelabels durexforth.lbl --report durexforth.lst durexforth.asm
